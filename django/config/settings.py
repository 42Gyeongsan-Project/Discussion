...
SECRET_KEY = 'django-insecure-m0&e(0xr+&t6ay99_v+dzeq$=)j#4u9aprz0uypi66_+l-kg&*'
...
OAUTH_AUTH_URL = 'https://api.intra.42.fr/oauth/authorize'
OAUTH_TOKEN_URL = 'https://api.intra.42.fr/oauth/token'
OAUTH_API_URL = 'https://api.intra.42.fr/v2/me'
